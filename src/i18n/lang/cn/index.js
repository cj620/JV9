...
const cn = {
  menu: {
    ...
    Pr_PartChart: "零件生产报表",
    Qu_Quality: "品质",
    Qu_ProductionCheck: "加工检验",
    Qu_QualityReport: "品质报表",
    Qu_QualityRecord: "检验记录",
    Qu_QualityError: "品质异常",
  ...
  quality: {
    Qu_CheckResult: "检验结果",
    Qu_CheckDate: "检验日期",
    Qu_EstimatedLoss: "预估损失",
    Qu_ProportionOfAbnormalQualityOfDepartment: "部门品质异常占比",
    Qu_ProcessReworkRatio: "工序返工占比",
    Qu_ReworkDetailList: "返工明细",
    Qu_Ge_QualityAbnormal: "品质异常",
    Qu_ThereAreNoManufacturedProcesses: "没有任何已加工的工序",
    Qu_PleaseSelectADocument: "请选择一条单据",
    Qu_CreatFromManufacturingTaskList: "从任务加工单创建",
    Qu_Qualified: "合格",
    Qu_Unqualified: "不合格",
    Qu_ToBeTested: "待检验",
    Qu_PleaseChooseTheUnqualifiedProcess: "选择不合格工序",
    Qu_Rework: "返工",
    Qu_Scrapped: "报废",
  },
  // 后端提示
