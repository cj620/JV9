...
const ja = {
  menu: {
    ...
    Qu_Quality: "品質",
    Qu_ProductionCheck: "プロセスチェツク",
    Qu_QualityReport: "品質レポート",
    Qu_QualityRecord: "チェツクレコード",
    Qu_QualityError: "品質異常",
  ...
  Generality: {
    ...
    Ge_Add: "追加＃ツイカ＃",
    Ge_Refresh: "リフレッシュ",
    Ge_Import: "インポート＃インポート＃",
    Ge_Export: "エクスポート＃エクスポート＃",
    Ge_Print: "印刷いんさつ",
    Ge_Settings: "設定＃セッテイ＃",
    Ge_Frame: "枠線",
    Ge_DottedLine: "横断歩道",
  ...
  quality: {
    Qu_CheckResult: "検査結果",
    Qu_CheckDate: "検査日",
    Qu_EstimatedLoss: "よさんそんしつ",
    Qu_ProportionOfAbnormalQualityOfDepartment: "部門品質異常占有率",
    Qu_ProcessReworkRatio: "工程再加工の割合",
    Qu_ReworkDetailList: "再加工明細",
    Qu_Ge_QualityAbnormal: "品質異常",
    Qu_ThereAreNoManufacturedProcesses: "加工された工程はありません",
    Qu_PleaseSelectADocument: "文書を選択してください",
    Qu_CreatFromManufacturingTaskList: "製造オーダーから作成",
    Qu_Qualified: "合格",
    Qu_Unqualified: "不合格",
    Qu_ToBeTested: "検査待ち",
    Qu_PleaseChooseTheUnqualifiedProcess: "不合格工程の選択",
    Qu_Rework: "やり直し",
    Qu_Scrapped: "廃棄",
  },
  // 后端提示
