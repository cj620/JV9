...
const ja = {
  menu: {
    Pr_NewProductionSchedule: "生産スケジュール",
    Pr_PendingWorkOrders: "排出待ち製造オーダ",
    Pr_SchedulingWorkOrders: "パラメータ製造オーダ",
    Pr_OverdueWorkOrder: "タイムアウト製造オーダ",
    Pr_ProcessLoad: "工程負荷",
    Pr_ProductionScheduling: "生産スケジューリング",
    Pr_SimulatedScheduling: "アナログレンジ",
    Pr_GanttChart: "ガント図",
    Pr_ExecutionScheduling: "実行スケジュール",
    Pr_MyTasks: "マイタスク",
    De_PartBomTable: "部品リスト",
    ...
    Pr_SubOrder: "製造オーダーサブオーダー",
    Pr_ParentOrder: "製造オーダー親",
    Login: "ログイン＃ログイン＃",
    Se_ErrorPrompt: "エラーメッセージ項目",
    Automation: "自動化",
    CustomSummaryManage: "カスタム要約",
    PoleStock: "でんきょくバンク",
    ...
    Pr_ToolingHoursSummary: "金型工数要約",
    Pr_PartHoursDetail: "部品工数詳細",
    ...
    As_ProductionFitterReceiveRecord: "クランプ受入記録",
  ...
  setup: {
    ...
    OptionallySign: "またはサイン",
    OptionallySignDes: "（承認者1人が同意または拒否すればよい）",
    EditMembers: "メンバーの編集",
    EditRoles: "ロールの編集",
    DesignatedMembers: "メンバーの指定",
    EndProcess: "プロセス終了",
    ApproveProcessConfiguration: "ストリーム構成のレビュー",
    RoleDefaultNavigationBar: "デフォルトのナビゲーションバー",
    SynchronizeERPData: "同期ERPデータ",
    Stockroom: "倉庫",
    SafetyStock: "安全在庫",
    MaxStock: "最大在庫",
    UserId: "ユーザー番号",
    ...
    PleaseInputPhoneNumberWithCorrectFormat: "正しい携帯番号を入力してください",
    ...
    IsCompulsoryPrograming: "強制的にプログラムするかどうか",
    CompulsoryInspection: "きょうせいチェツク",
    CompulsoryPrograming: "強制プログラミング",
  },
  //销售
  sale: {
    Sa_Bill: "オーダー",
  ...
  purchase: {
    ...
    Pu_DeliveryAchievementRate: "納期達成率",
    ...
    Pu_PleaseChooseTheNeededSheetFirst:
      "追加する文書を先にチェックしてください",
    Pu_Outsourced: "外注済み",
    Pu_ConfirmToHandle: "選択した文書ステータスをに変更するかどうか",
  },
  // 仓库
  stockroom: {
    St_Submitter: "送信者",
  ...
  Generality: {
    ...
    Ge_Logout: "ログアウト",
    Ge_Operate: "操作",
    Ge_OperationSuccessful: "操作が成功しました!",
    Ge_AddChild: "新規部下",
    Ge_CreateDate: "作成日",
    Ge_Details: "詳細",
    Ge_Describe: "説明",
    ...
    Ge_Skipped: "スキップされました",
    Ge_Cancelled: "キャンセル済み",
    Ge_TDA: "未課税金額",
    ...
    Ge_Task: "タスク",
    Ge_AllMsg: "すべてのメッセージ",
    Ge_UnreadMsg: "未読メッセージ",
    Ge_AllRemarkToRead: "すべて既読としてマーク",
    Ge_HistoryMsg: "履歴メッセージ",
    Ge_Handle: "しょり",
    Ge_RemarkToRead: "既読としてマーク",
    Ge_JustNow: "ちょうど",
    Ge_MinutesAgo: "分前",
    Ge_HoursAgo: "時間前",
    Ge_1DayAgo: "1日前",
  ...
  //生产
  production: {
    Pr_QuantityPerOrder: "1オーダーあたりの数量",
    Pr_SplitOrderQuantity: "請求数量",
    Pr_CustomSplitOrder: "カスタム受注",
    Pr_RemainingDetachableQuantity: "残りの取り外し可能数量",
    Pr_EqualSplittingOfOrders: "均等解体オーダー",
    Pr_ViewSubList: "サブオーダーの表示",
    Pr_ViewParentOrder: "親の表示",
    Pr_SplitOrder: "文書の分割",
    Pr_TaskManagement: "タスク管理",
    Pr_Running: "実行中",
    Pr_Standby: "待機中",
    Pr_Offline: "オフライン中",
    Pr_WhetherRecover: "リカバリの確認",
    Pr_DeletedList: "削除されたリスト",
    Pr_Device: "テーブル台",
    Pr_Unlock: "ロック解除",
    ...
    Pr_ClassicalAlgorithmDes:
      "一般的なアルゴリズム:同レベルでは完成度が高い優先",
    Pr_CR: "CR値スケジューリング",
    Pr_CRDes:
      "CR値スケジューリング:CR(重要比率)=(納期-現在日付)/工期、同等級ではCR値が小優先",
    ...
    Pr_SelectStartDate: "開始日の選択",
    Pr_SelectAlgorithm: "アルゴリズムの選択",
    Pr_StartAutomaticAPS: "自動スケジュールの開始",
    Pr_ReleaseAPSResults: "スケジュール結果の公開",
    Pr_APSReport: "スケジュールレポート",
    ...
    Pr_WhetherToUnlockAllAllocatedProcesses:
      "派遣されたすべての工程をロック解除するかどうか?",
    Pr_WhetherToLockAllAllocatedProcesses:
      "派遣されたすべての工程をロックするかどうか?",
  ...
  device: {
    ...
    De_Normal: "通常",
    De_Abnormal: "例外",
    De_PatrolInspection: "パトロール",
    De_DayCheck: "日次検査",
    De_WeekCheck: "週次検査",
    De_MonthCheck: "月の検査",
    De_QuarterlyCheck: "季節検査",
    De_YearCheck: "年次検査",
    De_Using: "有効化",
    De_Disable: "非アクティブ化",
    De_NotHandled: "処理しない",
    De_AutoCompletion: "自動完了",
    De_ToBeInspected: "検査待ち",
  ...
  backendMessage: {
    ...
    P10199: "成功したローの取得! ",
    P10200: "時間異常! ",
    P10201: "前の工程が完了していません！  ",
    P10202: "プログラミング工程でリソースグループが設定されていません! ",
    P10203: "コンテンツを空にすることはできません! ",
    P10204: "データを空にすることはできません! ",
    P10205: "品目がロックされている生産管理者に連絡してください!",
    P10206: "デバイスはロックされており、編集できません!",
    P10207: "レビューに失敗しました!",
  },
  program: {
    ...
    Pr_ProcessTaskCode: "製造オーダー工程コード",
    Pr_CreationDate: "作成時間",
    Pr_ProgramingTaskId: "生産加工プログラミングタスク番号",
    Pr_ActualStart: "実際の開始時間",
    Pr_ActualEnd: "実際の終了時間",
  ...
  systemSetupData: {
    ...
    Assy_users_name: "クランプユーザ",
    Assy_users_desc: "作業タスクの提示者",
    Fm_FileManager: "ファイル特別管理権限の設定",
    Fm_ViewFileHistory: "ファイル履歴の表示アクセス権構成",
    Email_switch_name: "メール送信スイッチ",
