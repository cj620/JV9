 ...
 * @LastEditTime: 2024-07-31 16:27:05
...
const en = {
  menu: {
    ...
    Pr_MyTasks: "My Tasks",
    De_PartBomTable: "Part Bom Table",
    Pr_ScanCodeToEnterTheStation: "ScanCode ToEnter The Station",
    Pr_ScanCodeToStartWork: "ScanCode To Start Work",
    ...
    CustomSummaryManage: "Custom Summary Manage",
    PoleStock: "Pole Stock",
    ElectorExceptionPost: "Elector Exception Post",
    ElectrodeUnPrint: "Electrode Release Printing",
    ToolStock: "Tool Stock",
    ProgramBill: "Program Bill",
    FixtureBase: "Fixture Base",
    PartList: "Part List",
    PoleProduceDemand: "Pole Produce Demand",
    Equipment: "Equipment",
    CmmProgramData: "Cmm Program Data",
    EDMTemplate: "EDM Template",
    ...
    Pa_ProgramProducingTaskItemInspection:
      "Program Producing Task Item Inspection",
    ...
    Pr_ProductionBlanking: "Production Blanking",
    ...
    Pr_ToolingHoursSummary: "Tooling Summary",
    Pr_PartHoursDetail: "Part Hours Detail",
    ...
    As_ProductionFitterReceiveRecord: "Production Fitter Receive Record",
    ...
    Se_AuditConfiguration: "Audit Configuration",
  ...
  design: {
    De_ToolingNo: "ToolingNo",
    De_ProductVersion: "Product Version",
    De_ShowInProjectManagementPage: "Show in project management page",
    De_DoesntShowInProjectManagementPage:
  ...
  project: {
    ...
    Pro_MoldSpecification: "Mold Specification",
    ...
    Pro_MoldBaseSpec: "Mold Base Spec",
  ...
  setup: {
    ...
    OptionallySign: "OptionallySign",
    OptionallySignDes: "(One approver can agree or refuse)",
    EditMembers: "Edit Members",
    EditRoles: "Edit Roles",
    DesignatedMembers: "Designated Members",
    EndProcess: "End of Process",
    ApproveProcessConfiguration: "Approve Process Configuration",
    RoleDefaultNavigationBar: "Default Navigation Bar",
    SynchronizeERPData: "Synchronize ERP Data",
    Stockroom: "Stockroom",
    ...
    PleaseInputPhoneNumberWithCorrectFormat:
      "Please input phone number with correct format",
  ...
  DataV: {
    ...
    Da_DataBoard: "Data Board",
    Da_EquipmentSignage: "Equipment",
    Da_DepartmentSignage: "Department Comprehensive",
    Da_SaleSignage: "Sale",
    Da_QualitySignage: "Quality",
    Da_MoldMachiningSignage: "Mold Machining",
    Da_EquipmentStateSignage: "Equipment State",
    ...
    Da_EquipmentDynamicCurve: "Equipment OEE Curve",
    Da_HUT: "HUT",
    Da_Alarm: "Alarm",
    ...
    Da_AlarmTime: "Alarm Time",
    Da_AlarmInfo: "Alarm Info",
    Da_State: "State",
    Da_DownTime: "Down Time",
    Da_StartTime: "Start Time",
    Da_EndTime: " ",
    Da_Above: "Above",
    Da_Under: "Under",
    Da_TotalProcessingQuantity: "Total Processing",
    Da_AccumulatedProcessingTime: "Accumulated Processing Time",
    Da_OEE: "OEE",
    Da_FaultAlarmQuantity: "Fault Alarm",
    ...
    Da_NCDepartmentSignboard: "NC Department",
    ...
    Da_TaskAchievementRate: "Task Achievement Rate",
    ...
    Da_RecordOfWorkingHoursInThePastSevenDays:
      "Record of working hours in the past seven days",
    Da_DailyProcessingTasks: "Daily Processing Tasks",
    Da_SortingOfWorkHoursReportedYesterday:
      "Sorting of work hours reported yesterday",
    Da_MonthlyOrderStatisticsForThisYear:
      "Monthly Order Statistics For This Year",
    Da_OrderClassificationStatistics: "Order Classification Statistics",
    Da_MonthlyShipmentStatisticsForThisYear:
      "Monthly Shipment Statistics For This Year",
    ...
    Da_InspectionTotalQty: "Total Inspections Submitted",
    ...
    Da_TotalSalesAmountThisYear: "Total Sales This Year",
    Da_TotalAmountNotShippedThisYear: "Total Not Shipped This Year",
    Da_ShippedAmountThisYear: "Shipped Amount This Year",
    Da_TotalSalesAmountThisMonth: "Total Sales This Month",
    Da_TotalAmountNotShippedThisMonth: "Total Not Shipped This Month",
    Da_ShippedAmountThisMonth: "Shipped Amount This Month",
    Da_EmergencyOrder: "Emergency Order",
    Da_ExpectedCropTurnoverRateOfEachDepartmentThisMonth:
      "Expected Crop Turnover Rate Of Each Department This Month",
    Da_CropTurnoverRateOfEachDepartmentThisMonth:
      "Crop Turnover Rate Of Each Department This Month",
    Da_ProjectProgressDisplay: "Project Progress Display",
    Da_AccumulatedShipmentStatusThisMonth:
      "Accumulated Shipment Status This Month",
    Da_NoData: "No Data",
  },
  // 模具综合看板
  Mold: {
    Mo_DailyPartsQualifiedRate: "Daily Qualified Rate of Parts",
    Mo_ExpectedDepartmentOEEThisMonth:
      "Expected Each Department's OEE This Month",
    Mo_DepartmentOEEThisMonth: "Each Department's OEE This Month",
    Mo_MoldProgress: "Mold Progress",
    Mo_QCThisMonth: "Quality Control Month",
    Mo_NewToolingThisMonth: "New Tooling",
    Mo_CorrectingToolingThisMonth: "Correcting Tooling",
    Mo_TrialMoldThisMonth: "Trial Mold",
    Mo_DesignChangeThisMonth: "Design Change",
    Mo_OrdersReceivedThisMonth: "Orders Received",
  ...
  Generality: {
    ...
    Ge_Lock: "Lock",
    Ge_InputPlaceholder:
      "Please input the document number, name, and department",
    Ge_Total: "total",
    Ge_Select: "Select",
    ...
    Ge_ReasonForNotAchievingThePlan1:
      "Reason for not achieving the plan (program)",
    Ge_ReasonForNotAchievingThePlan2:
      "Reason for not achieving the plan (Planning Engineer)",
    ...
    Ge_SelectNeededItems:
      "Please check the materials that need to be added first",
    Ge_CompletionStatus: "Completion Status",
    Ge_Monday: "Monday",
    Ge_Tuesday: "Tuesday",
    Ge_Wednesday: "Wednesday",
    Ge_Thursday: "Thursday",
    Ge_Friday: "Friday",
  ...
  production: {
    ...
    Pr_Standby: "Standby",
    Pr_Offline: "Offline",
    Pr_WhetherRecover: "Are you sure to restore",
    Pr_DeletedList: "Deleted Data List",
    Pr_Device: "Machine",
    Pr_Unlock: "Unlock",
    ...
    Pr_EditState: "Edit State:",
    Pr_PleaseEnterPartNumber: "Please Enter Part Number...",
    Pr_Unlabeled: "Unlabeled",
    Pr_Tagged: "Tagged",
    Pr_OldWorkOrderMark: "Old Work Order Mark",
    ...
    Pr_ClassicalAlgorithmDes:
      "ClassicalAlgorithm:Priority given to higher completion under the same level",
    Pr_CR: "CR",
    Pr_CRDes:
      "CR:CR(critical ratio)=(delivery date - current date)/working period.Priority given to lower CR value under the same level",
    Pr_MinimumWorkingPeriod: "Minimum Working Period",
    Pr_MinimumWorkingPeriodDes:
      "MinimumWorkingPeriod:Priority given to shorter working period under the same level",
    Pr_EarliestDeliveryDate: "Earliest Delivery Date",
    Pr_EarliestDeliveryDateDes:
      "EarliestDeliveryDate:Priority given to earlier delivery date under the same level",
    Pr_DoAPS: "Do aps",
    ...
    Pr_WhetherAddToSchedulingWorkOrderAll:
      "Whether To Add To Scheduling Work Order All",
    ...
    Pr_NegotiateToPostponeFollowingMolds:
      "Negotiate to postpone the delivery date of the following molds",
    Pr_OutsourceFollowingWorkOrders: "Outsource the following work orders",
    Pr_WorkpieceOutsourcing: "Workpiece Outsourcing",
    Pr_WorkOrderOutsourcing: "Work order outsourcing",
    ...
    Pr_ReAPS: "Reschedule",
    Pr_PlanTotalTime: "Plan Total Time",
    ...
    Pr_WhetherToUnlockAllAllocatedProcesses:
      "Whether to unlock all allocated processes?",
    Pr_WhetherToLockAllAllocatedProcesses:
      "Whether to lock all allocated processes?",
    Pr_WhetherToUnlockTheAllocatedProcess:
      "Whether to unlock the allocated process?",
    Pr_WhetherToLockTheAllocatedProcess:
      "Whether to lock the allocated process?",
    Pr_WhetherToClearAllAllocatedProcesses:
      "Whether to clear all allocated processes?",
    Pr_Locked: "Locked",
  ...
  quality: {
    ...
    Qc_SubmittedForInspectionQty: "Submitted for inspection quantity",
    ...
    Qc_TheQuantitySubmittedShallNotExceedTheProcessingQuantity:
      "The quantity submitted shall not exceed the processing quantity",
    Qc_TheQuantityForInspectionShallNotExceedTheSubmittedQuantity:
      "The quantity for inspection shall not exceed the submitted quantity",
    Qc_TheQuantityUnqualifiedShallNotExceedTheInspectionQuantity:
      "The quantity unqualified shall not exceed the inspection quantity",
  },
  device: {
    De_Repair: "Repair",
    ...
    De_SelfRepair: "Self Repair",
    De_OutsourcedRepair: "Outsourced Repair",
    De_ToBeRepair: "To Be Repair",
    De_Repairing: "Repairing",
    De_BackTo: "Back To",
    De_Accepted: "Accepted",
    De_Repaired: "Repaired",
    De_BeyondRepair: "Beyond Repair",
    De_RepairCategory: "Repair Category",
    ...
    De_PlanInfo: "Plan Info",
    De_PlanName1: "Plan Name",
    De_PlanType: "Plan Type",
    De_SpotCheckType: "Spot Check Type",
    De_ExecutionTime: "Execution Time",
    De_TimeOut: "Time Out",
    De_AfterTimeOut: "After Time Out",
    ...
    De_PatrolInspection: "Patrol Inspection",
    De_DayCheck: "Day Check",
    De_WeekCheck: "Week Check",
    De_MonthCheck: "Month Check",
    De_QuarterlyCheck: "Quarterly Check",
    De_YearCheck: "Year Check",
    De_Using: "Using",
    De_Disable: "Disable",
    De_NotHandled: "NotHandled",
    De_AutoCompletion: "AutoCompletion",
    De_ToBeInspected: "ToBeInspected",
    ...
    De_DeviceTotalQuantity: "Device Total Quantity",
    De_MaintenanceingQuantity: "Quantity Under Maintenance",
    De_RepairingQuantity: "Repairing Quantity",
    De_SpotCheckOverdueQuantity: "Spot Check Overdue Quantity",
    De_SpotCheckCompletionRate: "Spot Check Completion Rate",
    De_SpotCheckCompletionQuantity: "Spot Check Completion Quantity",
  ...
  backendMessage: {
    ...
    P10074: "The template name cannot be empty!",
    ...
    P10132:
      "Cannot delete the material requirement while it has been processed!",
    ...
    P10146: "The user code doesn't exist!",
    ...
    P10153:
      "Error:Repeatedly down-machine or wrong process state or wrong device.",
    ...
    P10205:
      "The material has been locked. Please contact the production management personnel!",
  ...
  program: {
    ...
    Pr_ProcessTaskCode: "Process Task Code",
    Pr_CreationDate: "Creation Date",
    Pr_ProgramingTaskId: "Programing Task Id",
    Pr_ActualStart: "Actual Start",
    Pr_ActualEnd: "Actual End",
  ...
  systemSetupData: {
    ...
    Assy_users_name: "Fitter users",
    Assy_users_desc: "Personnel showcasing fitter tasks",
    Fm_FileManager: "Special file management permission configuration",
    Fm_ViewFileHistory: "View File History Permission Configuration",
    Email_switch_name: "Email sending switch",
    ...
    Default_navigation_bar_configuration:
      "Default navigation bar configuration",
    ERP_inventory_category_configuration:
      "ERP inventory category configuration",
    ...
    Programming_default_responsible_person:
      "Programming default responsible person",
    Meanwhile_down_process_configuration:
      "Meanwhile down process configuration",
    ...
    Suggest_overall_outsourcing_percentage:
      "Suggest overall outsourcing percentage",
    ...
    Auto_create_purchase_requisition_desc:
      "Automatically create purchase request after material requirement review",
  },
  ...enLocale,
};
export default en;
