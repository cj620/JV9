  ...
  <div id="tags-view-container" class="tags-view-container">
    ...
    >
      ...
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">
        {{ $t("Generality.Ge_Close") }}
      </li>
      <li @click="closeOthersTags">{{ $t("Generality.Ge_CloseOthers") }}</li>
      <li @click="closeAllTags(selectedTag)">
        {{ $t("Generality.Ge_CloseAll") }}
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  computed: {
    visitedViews() {
      // console.log(this.$store.state.tagsView.visitedViews,'标题栏')
      ...
      this.$store
        ...
        .then(({ visitedViews }) => {
          if (this.isActive(view)) {
            // console.log(this.isActive(view),656565)
