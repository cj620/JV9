 ...
 * @LastEditTime: 2022-03-01 11:03:32
 * @Description: file content
 */
//销售订单明细 配置文件
// 引入表格表格类和表格API类
import { TableAPI, Table as BaseTable } from "@/jv_doc/class/table";
import { getSaleDeliveryDetails } from "@/api/workApi/sale/delivery";
class api extends TableAPI {
  // 获取列表
  getData = getSaleDeliveryDetails;
}
export class Table extends BaseTable {
  constructor() {
    super({
      ...
      // 表格标题
      title:
        i18n.t("menu.Sa_SaleDelivery") +
        "   " +
        i18n.t("Generality.Ge_Details1"),
      // 接口类
      api,
      // 打印模块标识
      printMod: "Sa_SaleDelivery_Detail_list",
      operationCol: false,
      printBar: false,
    });
  }
