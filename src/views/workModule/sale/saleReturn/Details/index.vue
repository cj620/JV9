...
/*import {
  ...
  rejectSalesReturn,
  auditSalesReturn,
  revokeAuditSalesReturn,
  deleteSalesReturn,
} from "@/api/workApi/sale/return";*/
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    //获取数据
    async GetData() {
      await Return.api_get({ BillId: this.$route.query.BillId }).then((res) => {
        ...
        this.btnAction = detailPageModel(this, res, Return, this.GetData);
      });
    },
    tabClick(e) {
