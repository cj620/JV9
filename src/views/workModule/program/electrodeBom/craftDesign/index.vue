  ...
  <PageWrapper ref="page">
    ...
    <JvBlock :title="$t('Generality.Ge_ProcessInfo')">
      <div slot="extra">
        ...
        <!--    <el-button size="mini" @click="addProcess">增加工序</el-button>
            <el-button size="mini" @click="selectProcessTemplate">选择模板</el-button>
    -->
      </div>
  ...
  methods: {
    ...
    save() {
      ...
      savePartProcess(str).then((res) => {
        let TagName = {
          path: "/program/electrodeBom",
          name: `ElectrodeBom`,
          fullPath: "/program/electrodeBom",
        };
