...
import NewStaffCard from "@/views/workModule/program/programProducingTask/List/cpns/NewStaffCard.vue";
import TaskBox from "@/views/workModule/program/programProducingTask/List/cpns/TaskBox.vue";
