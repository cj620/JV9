...
import { API as surplusIn } from "@/api/workApi/stockroom/surplusIn";
            ...
            this.eTableObj.validate((valid1) => {
              if (valid1) {
                surplusIn
                  ...
                  .then((res) => {
                    let TagName = {
                      path: "/picking/surplusInDetails",
                      name: `St_SurplusIn_Details`,
                      query: { BillId: res },
                      fullPath: "/picking/surplusInDetails",
                    };
