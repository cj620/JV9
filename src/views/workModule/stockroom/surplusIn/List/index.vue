<!--
 * @Author: H.
 * @Date: 2021-11-09 13:23:09
 * @LastEditTime: 2022-01-20 17:22:41
 * @Description: 报溢
-->
...
import { deleteStockSurplusIn } from "@/api/workApi/stockroom/surplusIn";
...
export default {
  ...
  data() {
    return {
      ...
      chooseList: [],
      // 编辑路由
      EditRoute: "St_SurplusIn_Edit",
      // 新增路由
      AddRoute: "St_SurplusIn_Add",
    };
  },
  created() {
