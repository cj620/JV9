 ...
 * @LastEditTime: 2022-01-20 17:21:51
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \JvMmsV9Front\src\views\workModule\stockroom\dispatch\List\c-menu.vue
-->
<!--
 * @Author: H.
 * @Date: 2021-11-09 13:21:38
 * @LastEditTime: 2021-11-09 13:21:38
 * @Description: 调拨
-->
...
import { deleteStockDispatch } from "@/api/workApi/stockroom/dispatch";
...
export default {
  ...
  data() {
    return {
      ...
      chooseList: [],
      // 编辑路由
      EditRoute: "St_Dispatch_Edit",
      // 新增路由
      AddRoute: "St_Dispatch_Add",
    };
  },
  created() {
