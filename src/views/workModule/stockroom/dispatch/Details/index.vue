...
import {
  API as dispatch
} from "@/api/workApi/stockroom/dispatch";
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    //获取数据
    async GetData() {
      await dispatch.api_get({ BillId: this.$route.query.BillId }).then((res) => {
        ...
        this.btnAction = detailPageModel(this, res, dispatch, this.GetData);
      });
    },
    tabClick(e) {
