...
import {
  API as picking
} from "@/api/workApi/stockroom/picking";
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    //获取数据
    async GetData() {
      await picking.api_get({ BillId: this.$route.query.BillId }).then((res) => {
        ...
        this.btnAction = detailPageModel(this, res, picking, this.GetData);
      });
    },
    tabClick(e) {
