<!--
 * @Author: your name
 * @Date: 2021-11-15 13:57:20
 * @LastEditTime: 2022-01-20 17:21:46
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \JvMmsV9Front\src\views\workModule\stockroom\costChange\List\c-menu.vue
-->
<!--
 * @Author: H.
 * @Date: 2021-11-09 13:19:55
 * @LastEditTime: 2021-11-09 13:19:55
 * @Description: 成本调整
-->
...
import { deleteStockCostChange } from "@/api/workApi/stockroom/costChange";
...
export default {
  ...
  data() {
    return {
      ...
      // 编辑路由
      EditRoute: "St_CostChange_Edit",
      // 新增路由
      AddRoute: "St_CostChange_Add",
