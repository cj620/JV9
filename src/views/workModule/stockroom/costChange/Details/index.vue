...
import {
  API as costChange
} from "@/api/workApi/stockroom/costChange";
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    //获取数据
    async GetData() {
      await costChange.api_get({ BillId: this.$route.query.BillId }).then((res) => {
        ...
        this.btnAction = detailPageModel(this, res, costChange, this.GetData);
      });
    },
    tabClick(e) {
