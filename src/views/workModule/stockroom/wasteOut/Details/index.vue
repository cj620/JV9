...
import {
  API as wasteOut
} from "@/api/workApi/stockroom/wasteOut";
export default {
  name: "index",
  data() {
    return {
  ...
  methods: {
    //获取数据
    async GetData() {
      await wasteOut.api_get({ BillId: this.$route.query.BillId }).then((res) => {
        ...
        this.btnAction = detailPageModel(this, res, wasteOut, this.GetData);
