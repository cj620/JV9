<!--
 * @Author: H.
 * @Date: 2021-11-09 13:22:24
 * @LastEditTime: 2022-01-20 17:22:44
 * @Description: 报损
-->
...
import { deleteStockWasteOut } from "@/api/workApi/stockroom/wasteOut";
...
export default {
  ...
  data() {
    return {
      ...
      chooseList: [],
      // 编辑路由
      EditRoute: "St_WasteOut_Edit",
      // 新增路由
      AddRoute: "St_WasteOut_Add",
    };
  },
  created() {
