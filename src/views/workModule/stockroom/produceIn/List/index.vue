...
<!--
 * @Author: H.
 * @Date: 2021-11-09 13:12:37
 * @LastEditTime: 2021-11-09 13:12:37
 * @Description: 生产入库
-->
...
import { deleteStockProduceIn } from "@/api/workApi/stockroom/produceIn";
...
export default {
  ...
  data() {
    return {
      ...
      chooseList: [],
      // 编辑路由
      EditRoute: "St_ProduceIn_Edit",
      // 新增路由
      AddRoute: "St_ProduceIn_Add",
    };
  },
  created() {
