...
import Dynamic from "@/views/workModule/project/projectManage/mouldDetail/cpns/Dynamic.vue";
import DynamicList from "@/views/workModule/project/projectManage/mouldDetail/cpns/DynamicList.vue";
