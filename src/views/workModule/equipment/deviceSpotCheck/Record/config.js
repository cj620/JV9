...
import {
  assets_device_spot_check_member_list
...
export class api extends TableAPI {
  getData = assets_device_spot_check_member_list;
}
export class Table extends BaseTable {
  constructor() {
    super( {
      ...
      rowId: 'Id',
      // 表格标题
      title: i18n.t("menu.As_DeviceSpotCheckRecord"),
      // 接口类
      api,
      // 操作列宽度
      operationCol: false,
      // 打印模块标识
      printMod:'As_DeviceSpotCheckRecord',
    })
  }
}
export const tableConfig = [
  {
    ...
    cpnProps: {
      // 路由名称
      routeName: "As_DeviceSpotCheckRecordDetail",
      // 路由路径（名称和路径二选一）
      // routePath:'/dashboard',
      // 路由传参方式 默认query
      methods: "query",
